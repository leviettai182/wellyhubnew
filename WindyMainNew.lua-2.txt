...
windy.New("Join Discord: discord.gg/AujVkQ3Bfq", 8)
windy.New("Welcome To さま┊Wellyhub", 5)
...
local Window = OrionLib:MakeWindow({Name = "さま┊Wellyhub", HidePremium = false, IntroText = "さま┊Wellyhub Community", SaveConfig = true, ConfigFolder = "Welly Hub"})


OrionLib:MakeNotification({
	Name = "さま┊Wellyhub",
	Content = "さま┊Wellyhub Loading...",
...
W:AddLabel("[+] さま┊Welly•Hub Rewrite Main")
W:AddLabel("[?] Developer: Wellyhubnew")
W:AddLabel("[!] Script is beta have bug please report in discord server")
W:AddLabel("[?] Discord: discord.gg/AujVkQ3Bfq")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "さま┊Wellyhun(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://17510500831",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "さま┊Wellyhub(Noitification)",
